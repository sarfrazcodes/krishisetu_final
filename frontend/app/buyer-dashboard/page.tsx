    ...
    <main className="p-4 md:p-8 relative z-10 w-full animate-fade-in max-w-7xl mx-auto">
      ...
      <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10 transition-all duration-300 ease-out transform ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
        ...
        <div className="bg-white border border-[#E2DFD3] shadow-sm p-6 rounded-[2rem] hover:shadow-md transition-shadow group">
          ...
          <h3 className="text-3xl font-black text-[#0A2F1D] tracking-tight">₹14.5L</h3>
        ...
        <div className="bg-white border border-[#E2DFD3] shadow-sm p-6 rounded-[2rem] hover:shadow-md transition-shadow group">
          ...
          <h3 className="text-3xl font-black text-[#0A2F1D] tracking-tight">850q</h3>
        ...
        <div className="bg-white border border-[#E2DFD3] shadow-sm p-6 rounded-[2rem] hover:shadow-md transition-shadow group">
          ...
          <h3 className="text-3xl font-black text-[#0A2F1D] tracking-tight">4</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pb-20">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="space-y-4">
            {/* Shipment Card 1 */}
            <div className="bg-white border border-[#E2DFD3] shadow-sm p-6 rounded-[2rem] flex flex-col md:flex-row md:items-center justify-between gap-6 hover:shadow-md transition-shadow">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 bg-[#FDF8EE] rounded-[1.5rem] flex items-center justify-center text-3xl">🌾</div>
                <div>
