...
export default function Navbar() {
  ...
  const toggleVoice = () => {
    ...
    // Hook up to Web Speech API or your voice handler here
  };
  ...
  return (
    ...
    >
      ...
      {/* INCREASED GAP HERE: gap-6 md:gap-8 gives space between logo and links */}
      <div className="flex items-center gap-6 md:gap-8">
        ...
        {/* Navigation links - INCREASED GAP HERE: gap-4 separates the boxes more */}
        <div className="hidden md:flex items-center gap-4">
          <NavLink href="/mandi-prices">Explore Mandi</NavLink>
      ...
      <div className="flex items-center gap-3 md:gap-4">
        ...
        <button
          ...
          className={`relative flex items-center justify-center w-11 h-11 rounded-xl border-2 border-b-[4px] font-bold transition-all
            ${isListening
              ? "bg-red-50 text-red-600 border-red-200 border-b-red-300 translate-y-[2px] !border-b-2 shadow-[0_0_15px_rgba(239,68,68,0.3)] animate-pulse"
        ...
        >
          {isListening && <span className="absolute inset-0 rounded-xl animate-ping bg-red-400 opacity-20" />}
        ...
        {/* 3D LOG IN BUTTON (Signature Green Style) */}
        <Link
          href="/login"
        ...
        {/* 3D SIGN UP BUTTON (Primary Gold Style) */}
        <Link
          href="/register"
